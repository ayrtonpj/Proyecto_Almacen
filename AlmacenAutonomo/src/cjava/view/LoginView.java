...
public class LoginView extends javax.swing.JFrame {
  ...
  private void initComponents() {
    ...
    jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cjava/imagenes/1354826118_Keychain Access.png"))); // NOI18N
    ...
    private void btnaceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnaceptarActionPerformed
      ...
      try {
        if (oUsuario.EmpleadoValidar(txtusuario.getText(), txtpassword.getText())) {
          objTimer = new Timer(50, new ClaseTime());
          objTimer.start();
